...
export default function Navbar() {
  ...
  const navLink =
    "relative text-slate-800 hover:text-black font-medium transition duration-300 after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full";
      ...
      <div className="max-w-[1600px] mx-auto px-12 lg:px-20">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-14">
            ...
            <a href="#WhatWeDo" className={navLink}>
              What We Do
            </a>

            <a href="#internships" className={navLink}>
              Internships
            </a>
